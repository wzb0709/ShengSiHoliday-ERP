    ...
    return (
      <>
        <div className="clearfix">
          ...
          >
            <div>
              {fileList[0] === '' ? '上传默认图' : <img src={fileList[0]} alt="avatar" style={{ width: '100%' ,height:85,objectFit:"cover" }} />}
            </div>
          </Upload>
        </div>
        <Row type='flex'>
          <Col span={7}>
            <Upload
              ...
              action="https://pzyfile.oss-cn-hangzhou.aliyuncs.com"
            >
              {fileList[1] === '' ? '上传图片' : <img src={fileList[1]} alt="avatar" style={{ width:140 ,height:85,objectFit:"cover" }} />}
            </Upload>
          </Col>
          <Col span={7}>
            <Upload
              ...
              action="https://pzyfile.oss-cn-hangzhou.aliyuncs.com"
            >
              {fileList[2] === '' ? '上传图片' : <img src={fileList[2]} alt="avatar" style={{ width:140 ,height:85,objectFit:"cover" }} />}
            </Upload>
          </Col><Col span={7}>
          <Upload
            listType="picture-card"
            ...
            action="https://pzyfile.oss-cn-hangzhou.aliyuncs.com"
          >
            {fileList[3] === '' ? '上传图片' : <img src={fileList[3]} alt="avatar" style={{ width:140 ,height:85,objectFit:"cover" }} />}
          </Upload>
        </Col>
        </Row>
      </>
