...
interface IProps {
  ...
  initialValue:IAttractionSearch
  onSearch:(values:IAttractionSearch) => void
}

export interface IAttractionSearch {
  search:string,
  status:number,
}
...
const AttractionSearch:FC<IProps> = (props) => {
...
export default Form.create<IProps>()(AttractionSearch)
