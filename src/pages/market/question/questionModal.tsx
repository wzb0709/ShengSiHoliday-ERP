...
const QuestionModal: FC<IProps> = (props) => {
  ...
  return (
    <Modal
      ...
      onOk={handleConfirm}
    >
      <FormItem label='问题标题' {...formItemLayout}>
        {getFieldDecorator('question_title', {
          initialValue: props.initialValue.question_title,
          rules: [
            {
              required: true,
              message: '请填写问题标题',
        ...
        })(<Input placeholder='请填写问题标题' style={{ width: '90%' }} />)}
      </FormItem>
      <FormItem label='问题内容' {...formItemLayout}>
        {getFieldDecorator('question_content', {
          initialValue: props.initialValue.question_content ? BraftEditor.createEditorState(props.initialValue.question_content) : undefined,
          rules: [{
            required: true,
...
export default Form.create<IProps>()(QuestionModal)
