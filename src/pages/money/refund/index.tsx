...
const Refund:FC = (props) => {
  ...
  const handleExport = () => {
    window.open(`http://test.allentravel.cn/api/report/expense?search=&status=${params.status}&start_time=${params.start_time}&end_time=${params.end_time}&sourceid=&type=2`)
  }
