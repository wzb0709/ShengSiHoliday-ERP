...
interface IProps {
  ...
  initialValue:IWithdrawSearch
  onSearch:(values:IWithdrawSearch) => void
}

export interface IWithdrawSearch {
  start_time:string,
  end_time:string
  status:number,
  search:string
...
const WithdrawSearch:FC<IProps> = (props) => {
...
export default Form.create<IProps>()(WithdrawSearch)
