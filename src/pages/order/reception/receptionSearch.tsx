...
interface IProps {
  ...
  initialValue:IReceptionOrderSearch
  onSearch:(values:IReceptionOrderSearch) => void
  memberList:Array<IMember>
}

export interface IReceptionOrderSearch {
  search:string,
  status:number,
  salesid:string,
  opid:string,
...
const ReceptionOrderSearch:FC<IProps> = (props) => {
...
export default Form.create<IProps>()(ReceptionOrderSearch)
