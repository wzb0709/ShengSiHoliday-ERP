...
interface IProps {
  ...
  initialValue:IShoppingSearch
  onSearch:(values:IShoppingSearch) => void
}

export interface IShoppingSearch {
  search:string,
  status:number,
}
...
const ShoppingSearch:FC<IProps> = (props) => {
...
export default Form.create<IProps>()(ShoppingSearch)
