...
interface IProps {
  ...
  initialValue:IDepartmentSearch
  onSearch:(values:IDepartmentSearch) => void
}
...
const DepartmentSearch:FC<IProps> = (props) => {
...
export default Form.create<IProps>()(DepartmentSearch)
